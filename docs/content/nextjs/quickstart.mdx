...
### Install `@c15t/react` & `@c15t/middleware` (optional) Packages
 ```package-install
 @c15t/react @c15t/middleware
 ```
</Step>
...
<Callout type="tip">
Instead of sending a request to your instance, the middleware will check if the cookie banner should be displayed, improving performance.
</Callout>
