...
- [Server-Based Consent Storage](/docs/nextjs/server-based-storage) - Standard mode connecting to a c15t backend (detailed configuration)
- [Self-Hosting with Next.js](/docs/nextjs/self-hosting) - Quickstart guide for setting up c15t in your Next.js API routes
- [Self-Hosting with Other Frameworks](/docs/backend) - General self-hosting information for various platforms
- [Offline Mode](/docs/nextjs/offline-mode) - Complete guide to using c15t without a backend
- [Custom Client](/docs/nextjs/custom-client) - Advanced implementation with custom handlers for full control
...
<div className="mt-6">
  <CompactCard 
    href="/docs/nextjs/client-config-options" 
...
Learn more about <code>Client Configuration Options</code>
  ...
  <CompactCard 
    href="/docs/nextjs/storing-consent/server-based-storage"
    icon={<RiFlashlightLine size={16} />}
  >
    Learn more about <code >Server-Based Consent Storage</code>
  </CompactCard>

  <CompactCard 
    href="/docs/nextjs/self-hosting"
    icon={<RiServerLine size={16} />}
  >
    Learn more about <code >Self-Hosting with Next.js</code>
  </CompactCard>

  <CompactCard 
    href="/docs/nextjs/storing-consent/offline-mode"
  ...
  <CompactCard 
    href="/docs/nextjs/storing-consent/custom-client"
