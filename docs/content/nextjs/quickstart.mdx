...
You can create an instance at [Consent.io](https://consent.io) or self-host your own instance. Otherwise, you can use c15t offline by setting `mode: 'undefined'`. More information on these methods can be found [below](#creating-a-consentio-instance-recommended). 
</Step>
</Steps>
