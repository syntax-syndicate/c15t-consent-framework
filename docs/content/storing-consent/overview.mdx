...
<CompactCard 
  href="/docs/nextjs/storing-consent/hosted-c15t" 
  icon={
...
<CompactCard 
  href="/docs/nextjs/storing-consent/self-hosting" 
  icon={
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
- [Hosted c15t](/docs/nextjs/storing-consent/hosted-c15t) - Use consent.io for a managed solution
- [Self-Hosting](/docs/nextjs/storing-consent/self-hosting) - Run your own c15t instance
- [Offline Mode](/docs/nextjs/storing-consent/offline-mode) - Store consent in the browser
- [Custom Client](/docs/nextjs/storing-consent/custom-client) - Implement your own storage logic 