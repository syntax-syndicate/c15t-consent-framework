...
For more complex applications or those with stricter compliance requirements, consider [Server-Based Storage](/nextjs/storing-consent/server-based-storage) instead.
