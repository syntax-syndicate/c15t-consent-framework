...
For simpler use cases, consider [Server-Based Storage](/nextjs/storing-consent/server-based-storage) or [Offline Mode](/nextjs/storing-consent/offline-mode) instead.
...
<div className="mt-6">
  ...
  >
    Learn about <code>Server-Based Storage</code>
  </CompactCard>
