...
<Callout type="info">
Looking for an easier way? [consent.io](https://consent.io) offers a fully managed c15t backend with minimal setup. See the [Server-Based Storage](/docs/storing-consent/server-based-storage) page for details.
</Callout>
