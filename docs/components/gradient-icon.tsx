...
import { TypeIcon as type, type LucideIcon, Waypoints } from 'lucide-react';
    ...
    >
      ...
      >
        <defs>
          ...
          <mask id={maskId}>
            <Icon className="w-[70%] h-[70%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 color-white" color="white" />
          </mask>
        </defs>
        <rect
          width="24"
