      ...
      return {
        ...
        showConsentBanner: async () => {
          ...
          if (!fetchCalls.has(backendURL)) {
            ...
            mockFetch(
              `${backendURL}/show-consent-banner`,
        ...
        setConsent: async () => ({ ok: true, data: { success: true }, error: null, response: null }),
        verifyConsent: async () => ({ ok: true, data: { valid: true }, error: null, response: null })
      };
    }
  };
});
