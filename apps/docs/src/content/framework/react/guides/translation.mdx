...
description: Learn how to translate consent.management components to your language with i18n.
---

## Understanding the Translation System

consent.management uses a simple yet powerful translation system that allows you to:
