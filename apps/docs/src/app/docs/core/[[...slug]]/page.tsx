...
export default async function Page(props: {
	...
	return SharedDocsPage({ params, source: coreSource });
}
 ...
 */
export const generateStaticParams = async () => coreSource.generateParams();
...
export async function generateMetadata(props: {
	...
	const params = await props.params;
	return generateSharedMetadata(params, coreSource);
}
